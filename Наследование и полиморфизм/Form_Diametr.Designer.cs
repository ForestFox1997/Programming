namespace Наследование_и_полиморфизм
{
    partial class Form_Diametr
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = "Form_Diametr";
            this.Text = "Расчёт по диаметру";
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.Form_Diametr_FormClosing);
